...
from .forms import ProductForm, AttributeForm
...
def product_detail(request, id):
    ...
    return render(request, 'product_detail.html',
                  {'data': product, 'related': related_products, 'colors': colors})
...
def product_add(request):
    ...
    return render(request, 'product_add.html', {'pform': pform, 'submitted': submitted, })
...
def attribute_add(request):
    ...
    if request.method == "POST" or request.method == "FILES":
        ...
        if form.is_valid():
            form.save()
            return HttpResponseRedirect('/attribute-add?submitted=True')
    else:
        form = AttributeForm
        if 'submitted' in request.GET:
            submitted = True

    return render(request, 'attribute_add.html', {'pform': form, 'submitted': submitted })
